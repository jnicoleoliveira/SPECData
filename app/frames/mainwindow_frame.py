...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1029, 712)
        MainWindow.setStyleSheet(_fromUtf8("background-color: rgb(0, 117, 135);"))
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.layoutWidget = QtGui.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(310, 270, 421, 291))
        font = QtGui.QFont()
        ...
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8("../../../OneDrive/Documents/applicaiton/specdata_logo.png")))
        self.label.setScaledContents(True)
        self.label.setObjectName(_fromUtf8("label"))
        self.layoutWidget.raise_()
        self.label.raise_()
        self.query_lbl.raise_()

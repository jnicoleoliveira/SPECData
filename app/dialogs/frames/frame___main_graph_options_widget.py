...
""))
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(12, 20, 341, 126))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("../../../resources/redisplay-graph.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.redisplay_btn.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("../../../resources/select-all.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("../../../resources/deselect-all.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.deselect_all_btn.setIcon(icon2)
        ...
        self.gridLayout_2.addWidget(self.matches_selections_grpbox, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.options_grpbox, 5, 0, 1, 1)
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 20, 341, 64))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("../../../resources/show-validations.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.show_pending_btn.setIcon(icon3)
        self.show_pending_btn.setObjectName(_fromUtf8("show_pending_btn"))
        self.view_layout.addWidget(self.show_pending_btn, 1, 0, 1, 1)
        self.show_validations_btn = QtGui.QPushButton(self.gridLayoutWidget)
        self.show_validations_btn.setIcon(icon3)
        self.show_validations_btn.setObjectName(_fromUtf8("show_validations_btn"))
        self.view_layout.addWidget(self.show_validations_btn, 2, 0, 1, 1)
        self.show_invalid_btn = QtGui.QPushButton(self.gridLayoutWidget)
        self.show_invalid_btn.setIcon(icon3)
        self.show_invalid_btn.setObjectName(_fromUtf8("show_invalid_btn"))
        self.view_layout.addWidget(self.show_invalid_btn, 3, 0, 1, 1)
        self.gridLayoutWidget.raise_()
        self.show_pending_btn.raise_()
        self.show_validations_btn.raise_()
        self.show_invalid_btn.raise_()
        self.gridLayout_2.addWidget(self.view_grpbox, 4, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Graph ", None))

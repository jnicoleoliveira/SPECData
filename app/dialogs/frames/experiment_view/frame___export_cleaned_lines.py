...
# Form implementation generated from reading ui file 'export_cleaned_lines.ui'
#
...
""))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 819, 214))
        ...
        self.select_file_txt = QtGui.QLineEdit(self.frame_5)
        self.select_file_txt.setStyleSheet(_fromUtf8("background-color: rgb(82, 82, 82);\n"
"color: rgb(255, 255, 255);"))
        self.select_file_txt.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.select_file_txt.setObjectName(_fromUtf8("select_file_txt"))
        self.gridLayout.addWidget(self.select_file_txt, 1, 0, 1, 1)
        self.select_file_btn = QtGui.QToolButton(self.frame_5)
        self.select_file_btn.setObjectName(_fromUtf8("select_file_btn"))
        self.gridLayout.addWidget(self.select_file_btn, 1, 1, 1, 1)
        self.label = QtGui.QLabel(self.frame_5)
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.gridLayout_4.addWidget(self.frame_5, 2, 0, 2, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Please check the validated molecules to be removed from remaining lines:", None))
        self.label_3.setText(_translate("Dialog", "Export Cleaned Lines", None))
        self.label_4.setText(_translate("Dialog", "Choose from validated molecules to be cleaned. Click \'OK\' to accept.", None))
        ...
        self.label.setText(_translate("Dialog", "Export cleaned lines to:", None))

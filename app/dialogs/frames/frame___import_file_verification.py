...
""))
        ...
        self.gridLayout.addWidget(self.isotope_chkbx, 8, 1, 1, 1)
        self.units_combobx = QtGui.QComboBox(Dialog)
        self.units_combobx.setObjectName(_fromUtf8("units_combobx"))
        self.gridLayout.addWidget(self.units_combobx, 3, 1, 1, 1)
...
"color: rgb(25, 25, 25);"))
        ...
        self.gridLayout.addWidget(self.notes_txt, 14, 1, 1, 1)
...
"color: rgb(25, 25, 25);"))
        ...
        self.gridLayout.addWidget(self.composition_txt, 4, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_8.setText(_translate("Dialog", "Other", None))
        ...
        self.label.setText(_translate("Dialog", "*Units", None))
